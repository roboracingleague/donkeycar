OBSTACLE_DETECTOR_MODEL_PATH = "/home/donkey/donkeycar-models/trt/detector-A031.trt"
...
ROBOCARSHAT_PWM_OUT_STEERING_IDLE   =   1435
...
ROBOCARSHAT_PWM_IN_THROTTLE_MIN    =   986
ROBOCARSHAT_PWM_IN_THROTTLE_IDLE   =   1485
ROBOCARSHAT_PWM_IN_THROTTLE_MAX    =   1989
ROBOCARSHAT_PWM_IN_STEERING_MIN    =   1002
ROBOCARSHAT_PWM_IN_STEERING_IDLE   =   1467
...
ROBOCARSHAT_THROTTLE_FLANGER = [-0.7, 0.45] # High speed flanger
...
FIX_THROTTLE = {
    'ROBOCARSHAT_PILOT_MODE' : 'local_angle',
    'ROBOCARSHAT_LOCAL_ANGLE_FIX_THROTTLE' : 0.25
}

DUAL_THROTTLE = {
    'ROBOCARSHAT_PILOT_MODE' : 'local',
    'ROBOCARS_THROTTLE_DUAL_THROTTLE_MODEL' : 'True',
    'ROBOCARS_THROTTLE_LOW' : 0.30,
    'ROBOCARS_THROTTLE_HIGH' : 0.37,
}
...
ROBOCARS_CONFIG_PROFILE = {**SLALOM, **COPILOT}
