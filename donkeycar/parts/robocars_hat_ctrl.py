...
class RobocarsHatLedCtrl():
    ...
    def __init__(self, cfg):
        ...
        if cfg.ROBOCARSHAT_LED_MODEL == 'Duo':
    ...
    def run (self, steering, throttle, mode):
        ...
        # refresh LED each 2 seconds, help to synch back LEDS is connection is lost
        ...
        # did we switchedd from user to pilot or reverse ?
