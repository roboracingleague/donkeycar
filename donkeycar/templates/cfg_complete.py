...
RGB_RESOLUTION = "800p" # 1280*800 -> 1280*660 -> 560

RGB_APPLY_CROPPING = True
RGB_SENSOR_CROP_X = 0.0
RGB_SENSOR_CROP_Y = 0.175
RGB_VIDEO_SIZE = (320,165)#(320,140)
...
# 'switch_profile' means special mode where aux ch is used to explore adaptative steering scalar to apply on steering when autopilot is engaged 
...
ROBOCARSHAT_CIRCUIT_24_CONTROL = False
...
ROBOCARS_PROFILES = None # Array of [throttle scalar, steering scalar, ledAnim], for exemple :  [[0.0, 0.0, None],[0.2,0.5,1],[0.4,1.0,2]]
